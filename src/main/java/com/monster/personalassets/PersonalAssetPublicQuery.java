...
/**
 * A query object for public {@link PersonalAsset} list.
 */
public class PersonalAssetPublicQuery extends SortableRequest {

    public PersonalAssetPublicQuery(ServerWebExchange exchange) {
        super(exchange);
    }
